...
**Objetivo:** Criar uma classe que lê um arquivo de texto e imprime seu conteúdo na tela. Se o arquivo não existir, o programa deve informar o usuário e criar um arquivo vazio com o nome solicitado.
...
3. Utilize a estrutura Try-Catch para capturar uma `FileNotFoundException` e informar ao usuário que o arquivo não foi encontrado.
