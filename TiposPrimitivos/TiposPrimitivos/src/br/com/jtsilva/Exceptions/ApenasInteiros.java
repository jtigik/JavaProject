...
**Objetivo:** Criar uma classe que solicita ao usuário que insira um número inteiro. Se o usuário
inserir um valor que nãoseja um número inteiro, o programa deve capturar a exceção e solicitar
...
3. Utilize a estrutura Try-Catch para capturar qualquer `InputMismatchException` que possa surgir
se o usuário inserir dados que não são um número inteiro.
